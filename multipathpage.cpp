#include "multipathpage.h"

MultiPathPage::MultiPathPage(QWidget *parent)
	: QWidget(parent)
...
MultiPathPage::~MultiPathPage()
{

}
void MultiPathPage::initPlot()
{
...
void MultiPathPage::startTest(bool bpause)
{
